 ...
 * @author Yamin
 */
public class PerpustakaanNusaPutra {
   ...
   int keluar = 0;
        ...
        dataMahasiswa.add(new Mahasiswa("20200040077", "M. Yamin"));
        dataMahasiswa.add(new Mahasiswa("20200040087", "Helma Fortuna"));
        dataMahasiswa.add(new Mahasiswa("20200040012", "Nurul Islam Hasanah"));
        dataMahasiswa.add(new Mahasiswa("20200030104", "Alia Azhar"));

        ArrayList <Buku> dataBuku = new ArrayList<>();

        dataBuku.add(new Buku("001", "How Democracy Die"));
        dataBuku.add(new Buku("002", "Layla Majun"));
        dataBuku.add(new Buku("003", "CEH Version 11"));
        dataBuku.add(new Buku("004", "Ayat Ayat Cinta"));
